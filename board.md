...
|---|---|---|---|---|---|
| STI-G1 | 매핑표 33행 검토 대기 (12일) | BU-030 매핑표 | jw | 쟁점 4건 판정 → 승인 행만 적재 | 08-07 |
| SA-0 | Anchor 청산룰 미정의 | — | jw | 최소 청산룰 1판 확정 → G-A 해제 | 08-07 |
| 파이프 | ORDER 002 PC2→PC1 왕복 실증 완료 | A-4 단독파일 14개 목록 / remote-control ON | (비어있음) | B-7: PC1 git pull 확인 | 08-08 |
